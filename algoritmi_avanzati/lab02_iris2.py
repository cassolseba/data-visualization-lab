...
# definiti nella libreria "ml" definita in lab02_ml.py
#
# Richiede la presenza del file "iris.data" (dal repository UCI)
# e del file lab02_ml.py nella stessa directory.
#
# Esecuzione:
#    python2 lab02_iris2.py
# oppure
#    chmod 755 lab02_iris2.py   <--- una tantum
#    ./lab01_iris.py
#
...
# Questa è la libreria definita in lab02_ml.py
import lab02_ml
...
##############################################
#
# Utilizzo dell'algoritmo KNN implementato in lab02_ml.py
...
##############################################
#
# Utilizzo della regressione ai minimi quadrati implementata in lab02_ml.py
#
